        ...
        <div className={`mobile-menu-container ${mobileMenu && "show-mobile-menu-container"}`}>
            <ul className="mobile-menu">
                ...
                <li className="mobile-menu-item">
                    ...
                    className="mobile-menu-link" 
                    onClick={handleClickUpcoming}>Upcoming</Link>
                </li>
                <li className="mobile-menu-item">
                    <Link to="/top-rated-movies" 
                    className="mobile-menu-link" 
                    onClick={handleClickTopRated}>Top rated</Link>
                 </li>
                <li className="mobile-menu-item">
                    <Link to="/popular-movies" 
                    className="mobile-menu-link" 
                    onClick={handleClickPopular}>Popular</Link>
                </li>
                <li className="mobile-menu-item">
                    <Link to="/search" 
                    className="mobile-menu-link" 
                    onClick={handleClickSearch}>Search</Link>
                </li>
            </ul>
        </div>
    )
